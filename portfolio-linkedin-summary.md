...
AI Workflow Portfolio: Human-Reviewed Decision Support and Workflow Modernization
...
Use this project to signal AI workflow design and practical solution thinking. The strongest framing is not "I use AI tools." The stronger framing is:

> I design repeatable workflows that use AI to convert messy real-world inputs into structured, reviewed, decision-support outputs.

This aligns with AI Solutions Engineer, Technical Marketing, Technical Enablement, Customer Engineer, Solutions Architect, and workflow modernization roles.
