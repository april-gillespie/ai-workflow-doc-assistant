...
This portfolio is designed to show capability in:
...
### AI-Assisted Resume Transformation Workflow
...
Location: `prompts/review_prompt_v1.md`

### Workflow and Architecture Notes

Early documentation outlining the human-in-the-loop review structure used for AI-assisted document review.
...
6. Refine the process so it can be repeated more consistently.
...
- Technical marketing and enablement workflows
